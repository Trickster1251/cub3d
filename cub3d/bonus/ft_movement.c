...
int	release_key(t_all* a)
{
	...
	if (a->key.s == 1)
	{
        if (a->map[(int)a->plr.y][(int)(a->plr.x - a->plr.plane_y * MOVE_SPEED)] != '1')
        {
            ...
            if (a->map[(int)a->plr.y][(int)(a->plr.x - a->plr.plane_y * MOVE_SPEED)] == '2')
            {
                a->map[(int)a->plr.y][(int)(a->plr.x -= a->plr.plane_y * MOVE_SPEED)] = '0';
                a->plr.apple++;
            }
            if (a->map[(int)a->plr.y][(int)(a->plr.x - a->plr.plane_y * MOVE_SPEED)] == 'T')
            {
                a->plr.x = a->t_x;
                a->plr.y = a->t_y;
            }
        ...
        if (a->map[(int)(a->plr.y + a->plr.plane_x * MOVE_SPEED)][(int)a->plr.x] != '1')
        {
            ...
            if (a->map[(int)(a->plr.y + a->plr.plane_x * MOVE_SPEED)][(int)a->plr.x] == '2')
            {
                a->map[(int)(a->plr.y += a->plr.plane_x * MOVE_SPEED)][(int)a->plr.x] = '0';
                a->plr.apple++;
            }
            if (a->map[(int)(a->plr.y + a->plr.plane_x * MOVE_SPEED)][(int)a->plr.x] == 't')
            {
                a->plr.x = a->T_x;
                a->plr.y = a->T_y;
            }
